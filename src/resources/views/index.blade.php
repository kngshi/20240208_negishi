        ...
        <div class="form__group">
          ...
          <div class="form__group-content">
            <div class="form__input--text">
              ...
              <!-- 2つのインプットタグを、１行で表示させるにはどうしたら良いか？ DBとの整合性が取れないので、今回はテーブルに姓と名のカラムをそれぞれ作成。 -->
            </div>
        ...
        <div class="form__group">
          ...
          <div class="form__group-content">
            <div class="form__input--radio" >
              <input type="radio" name="gender" class="gender" value="男性" />男性
              <input type="radio" name="gender" class="gender" value="女性" />女性
              <input type="radio" name="gender" class="gender" value="その他" />その他
            </div>
            <div class="form__error">
              <!--バリデーション機能を実装したら記述します。-->
              @error('gender')
